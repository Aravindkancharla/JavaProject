    ...
    <div class="form-container">
        ...
        <form action="insertevent" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-input" id="description" name="description" required 
                          placeholder="Provide a detailed description of the event"></textarea>
            </div>

            <div class="form-group">
                <label class="form-label" for="addedby">Event Organizer</label>
                <input type="text" class="form-input" id="addedby" name="addedby" required 
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-input" id="availableSlots" name="availableSlots" 
                       required min="1" placeholder="Enter number of available slots">
            </div>
