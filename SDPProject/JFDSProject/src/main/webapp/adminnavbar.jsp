...
<div class="navbar">
    ...
    <div class="nav-item" onclick="showModal('studentsModal')">
        <i class="fas fa-user-graduate"></i>
        Students
    </div>
    
    <div class="nav-item" onclick="showModal('eventsModal')">
...
<div id="studentsModal" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-options">
            ...
            <a href="deletestudents" class="modal-option">
                <i class="fas fa-user-minus"></i>
                <div class="modal-option-content">
                    <h4>Delete Students</h4>
                    <p>Remove students from the system</p>
                </div>
            </a>
        </div>
    </div>
...
<div id="eventsModal" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-options">
            ...
            <a href="Viewallevents" class="modal-option">
                <i class="fas fa-calendar-week"></i>
                <div class="modal-option-content">
                    <h4>View All Events</h4>
                    <p>See complete list of scheduled events</p>
                </div>
            </a>
            <a href="deleteevents" class="modal-option">
                <i class="fas fa-calendar-minus"></i>
                <div class="modal-option-content">
                    <h4>Delete Events</h4>
                    <p>Remove events from the calendar</p>
                </div>
            </a>
        </div>
    </div>
